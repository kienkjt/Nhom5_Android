...
import com.nhom5.healthtracking.R; // ✅ Import đúng R
...
public class StepActivity extends AppCompatActivity {
    ...
    private static final int USER_ID = 1; // giả lập
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int stepsToday = getStepsToday();
        saveStepData(stepsToday);
        updateUI(stepsToday);
        showChart();
    }
    ...
    private int getStepsToday() {
        ...
        return new Random().nextInt(DAILY_GOAL + 2000); // Dùng để tích hợp gg fit về sau này
    }
